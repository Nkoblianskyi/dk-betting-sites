      ...
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-4 max-w-5xl mx-auto">
          {sites.map((site, index) => (
            <Card
              key={site.id}
              className={`overflow-hidden border-2 border-gray-700 bg-gradient-to-r from-gray-800 to-gray-900 hover:border-yellow-500 transition-all transform hover:scale-[1.02] shadow-2xl animate-slide-in-up hover-lift hover-glow stagger-${index + 1}`}
            >
              <CardContent className="p-4">
                <div className="flex flex-row items-center justify-between gap-4 flex-wrap">
                  ...
                  {/* CTA Button */}
                  <Button
                    className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-black px-6 py-3 text-lg shadow-xl border-2 border-red-400 transform hover:scale-105 transition-all animate-pulse-glow hover-lift"
                ...
                <div className="mt-3 pt-3 border-t border-gray-700 text-xs text-gray-400 animate-slide-in-up">
                  <p>
                    ...
                    vilkår er altid gældende | SPIL ANSVARLIGT | STOPSPILLET.DK | ROFUS
                  </p>
                </div>
              </CardContent>
            </Card>
